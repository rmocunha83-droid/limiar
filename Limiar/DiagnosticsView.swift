...
struct DiagnosticsView: View {
    ...
    var body: some View {
        ZStack {
            ...
            Form {
                Section {
                    Text("Eventos do shield, dos anúncios, da narração e da pré-geração da próxima travessia. Os eventos \"monitor.*\" provam que a extensão rodou com o app fechado.")
                        .font(.caption)
