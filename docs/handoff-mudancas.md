...
- **Medição:** Firebase recebe `gate_offer_viewed`, `gate_offer_accepted` e `gate_offer_declined{reason: annual|all_plans|background}`. O ciclo de compra existente registra `plan=monthly_welcome`; a Meta não recebe preço nem plano novo.
