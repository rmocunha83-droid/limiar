...
| `limiar_premium_yearly` | Anual | R$ 89,90/ano | Não configurada por padrão |
...
8. Vê o paywall com mensal, anual, restauração, termos e privacidade.
...
Depois do onboarding, o usuário inicia 7 dias grátis com experiência completa. Para testar a assinatura, toque em `Ver planos` ou `Assinar Premium` e escolha o plano mensal ou anual disponível no StoreKit.
...
Build `1.0 (23)` foi enviada ao App Store Connect com sucesso. O pacote de distribuição inclui `com.apple.developer.family-controls` no app principal.
...
7. Opcionalmente, configure oferta introdutória gratuita de 7 dias nos produtos, caso a estratégia passe a usar oferta StoreKit.
