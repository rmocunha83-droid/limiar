# Campos para App Store Connect - Limiar
...
- ID do pacote: XC com romeucunha Limiar - com.romeucunha.Limiar
- SKU: limiar-ios-001
...
- Nome de referência: `Limiar Premium Monthly`
- Nome exibido: `Limiar Premium Mensal`
- Duração: 1 mês
- Preço: R$ 9,90
- Disponibilidade: Brasil
- Oferta introdutória: teste grátis de 1 semana, Brasil, início em 06/08/2026, sem data final
...
Depois do onboarding, usuários novos encontram um portão de assinatura sem opção de pular. O plano mensal e o anual oferecem 7 dias grátis aos clientes elegíveis; um entitlement ativo, inclusive durante o teste, libera o dashboard. Usuários legados preservam o fluxo anterior, inclusive o Modo Essencial.
